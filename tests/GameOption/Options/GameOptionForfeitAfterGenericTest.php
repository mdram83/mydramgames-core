...
class GameOptionForfeitAfterGenericTest extends TestCase
{
    ...
    {
        $this->default = GameOptionValueForfeitAfterGeneric::Disabled;
        $this->configured = GameOptionValueForfeitAfterGeneric::Minute;
        ...
        $this->option = new GameOptionForfeitAfterGeneric($this->available, $this->default, $this->type);
    }
    ...
    public function testConstructorThrowExceptionWhenUsingIncompatibleValues(): void
    {
        ...
        new GameOptionForfeitAfterGeneric($this->available, $incompatibleOption, $this->type);
    }
